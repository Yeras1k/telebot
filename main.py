...
def input_data(message):
    ...
    db_object.execute(f"INSERT INTO students(id, name, surname, class, litter, email, phone) VALUES ({user_id}, '{data1[0]}', '{data1[1]}', {int(data1[2])}, '{data1[3]}', '{data1[4]}', {int(data1[5])})")
